sap.ui.define([
	...
	return BaseController.extend("kj.controller.CreateEntity", {
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("TravelAgencies", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("TravelAgencies", oData);
